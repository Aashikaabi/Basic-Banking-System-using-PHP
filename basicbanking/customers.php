  ...
  <div class="row">
    <div class="col">
      <div class="table-responsive-sm">
        <table class="table table-hover table-sm table-striped table-condensed table-bordered" style="border-color:#225470;">
          ...
          <tbody>
            ...
            <tr style="color : white;">
              ...
              <td><a href="userdetail.php?id= <?php echo $rows['id'] ;?>"> <button type="button" class="btn" style="background-color : #A569BD;">Transfer money</button></a></td> 
            </tr>
            <?php
              }
            ?>
...
<footer class="text-center mt-5 py-2">
  <p>&copy 2021 <b>Aashika</b> <br>Indian Bank</p>
</footer>
